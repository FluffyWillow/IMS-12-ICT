...
if (isset($_POST["search_term"])) {
    ...
    $sql = "SELECT * FROM records WHERE Student_Name LIKE '%$search_term%' OR Grade_Section LIKE '%$search_term%' OR Infraction LIKE '%$search_term%' OR Strand LIKE '%$search_term%' ORDER BY Student_Name";
} else {
    // SQL query to retrieve data from the table
...
<body>
                ...
                <!-- <div class="nav_nav">
                    <div class="main_nav">
                            <nav class="content_nav">
                                <div class="add">
                                    <ul>
                                        <a href="../pages/Add.html"><li>Add</li></a>
                                    </ul>
                                </div>
                            </nav>
                    </div>
    ...
    <form action="Main.php" method="post">
        <input type="submit" name="list_view" value="List View" class="list_view">
    </form>
        </nav>
    </div>
    <div class="main_nav">
            ...
            <?php foreach ($record["Infractions"] as $infraction): ?>
                <tr>
                    ...
                    <td> 
                        ...
                        <input type="hidden" name="rec_id" value="<?php echo $infraction["Rec_ID"]; ?>">
                        <button type="submit" name="delete_item" onclick="return confirm('Are you sure you want to delete this item?');" class="remove">Remove Item</button> 
                        </form>
                    </td>
                    <td>
                        <form method="post" action="Edit.php">
                            <input type="hidden" name="rec_id_e" value="<?php echo $infraction["Rec_ID"]; ?>">
                            <input type="submit" name="edit_item" value="Edit Item" class="edit">
                        </form>
                    </td>
                    <td>
                        <form method="post" action="Show.php">
                            <input type="hidden" name="rec_id_s" value="<?php echo $infraction["Rec_ID"]; ?>">
                            <input type="submit" name="show_item" value="Show Item" class="Show">
                        </form>
                    </td>
                </tr>
            <?php endforeach; ?>
